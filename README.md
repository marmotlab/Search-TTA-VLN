...
* `Quad-modal`: Sat-Text-Image-Sound pairing modalities 
    ...
    * [Search Evaluation](https://huggingface.co/datasets/derektan95/avs-bench/viewer/search_quad_modal)
* `Tri-modal`: Sat-Text-Image pairing modalities 
    * [CLIP Training](https://huggingface.co/datasets/derektan95/avs-bench/viewer/clip_tri_modal)
    * [Search Evaluation](https://huggingface.co/datasets/derektan95/avs-bench/viewer/search_tri_modal)
...
### RL Planner
To train the RL planner, follow the steps below. The planner is trained using the score maps and envs from `maps/GT_GPT4o`, which are generated by converting point locations to segmentation score masks using GPT4o. 
