...
# For running CLIP AVS with and without TTA (Sound) + RL Planner
...
export AVS_SOUND_CHECKPOINT_PATH=""    # If loading locally
...
export QUERY_TAX=""
export AVS_SAT_TO_IMG_IDS_PATH="search_eval_quadrimodal|val_in_domain"
...
export OVERRIDE_MASK_DIR=""
export QUERY_TAX=""
export AVS_SAT_TO_IMG_IDS_PATH="search_eval_quadrimodal|val_out_domain"
